...
QLU 工具箱是一款面向齐鲁工业大学学生的本地校园效率桌面软件。v1.0.3 使用 Vue 3、TypeScript 与 Electron 提供桌面界面，Python 与 Playwright 负责可靠的本地自动化。当前内置“分项成绩导出”和“绩点计算器”两个教务工具，后续工具将通过统一模块规范逐步加入。
